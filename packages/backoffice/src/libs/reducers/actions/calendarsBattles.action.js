...
import { postCalendarsBattles, fetchCalendarsBattlesOne, fetchCalendarsBattles, deleteCalendarsBattles, patchCalendarsBattles } from "@/libs/utils/calendarsBattles";
  ...
  async (datas, thunkAPI) => {
    try {
      ...
      if (value !== null) {
        ...
        const data = await patchCalendarsBattles(datas, config);
        thunkAPI.dispatch({ type: "tables/putCalendarsBattles", payload: data });
        return data; //////
      }
      return null;
    } catch (error) {
  ...
  async (datas, thunkAPI) => {
    try {
      ...
      if (value !== null) {
        ...
        const data = await deleteCalendarsBattles(datas, config);
        thunkAPI.dispatch({ type: "tables/deleteCalendarsBattles", payload: datas });
        return data; //////
      }
      return null;
    } catch (error) {
