...
export const addActionsFetch = createAsyncThunk(
  "actions/add",
...
export const changeLatestActionFetch = createAsyncThunk(
  "actions/changeLatestAction",
  async (datas, thunkAPI) => {
    try {
      const config = {
        headers: {
...
export const deleteActionsFetch = createAsyncThunk(
  "actions/delete",
  async (datas, thunkAPI) => {
    try {
      const config = {
...
export const putActionsFetch = createAsyncThunk(
  "actions/put",
  async (datas, thunkAPI) => {
    try {
      const config = {
