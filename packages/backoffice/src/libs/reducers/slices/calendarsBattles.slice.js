...
export const calendarsBattlesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    //////CHANGE RULLING ACTIVE
    builder.addCase(changeRullingActiveFetch.pending, (state, { payload }) => {
      state.calendarsBattlesStatus = "pending"
    });

    builder.addCase(changeRullingActiveFetch.fulfilled, (state, action) => {
      state.calendarsBattlesStatus = "success"
      state.rullingDatas = action.payload
    });

    builder.addCase(changeRullingActiveFetch.rejected, (state, action) => {
      state.calendarsBattlesStatus = "rejected"
